...
const MIGRATIONS: &[(&str, &str)] = &[
    ...
    (
        "0009_name_radar",
        include_str!("../../migrations/0009_name_radar.sql"),
    ),
    (
    ...
    (
        "0012_third_wipe",
        include_str!("../../migrations/0012_third_wipe.sql"),
    ),
    (
        "0013_reference_wipe",
    ...
    (
        "0015_distribution",
        include_str!("../../migrations/0015_distribution.sql"),
    ),
    (
        "0016_merge_sessions",
        include_str!("../../migrations/0016_merge_sessions.sql"),
    ),
];
